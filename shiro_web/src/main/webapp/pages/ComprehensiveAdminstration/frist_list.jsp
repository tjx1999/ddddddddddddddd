						...
						<div class="span12">
									...
									<table class="table table-striped table-bordered table-hover" id="sample_1" style="border-top:none 0px">
										...
										<thead>
											...
											<tr>
												...
												<th>员工姓名</th>
												<th class="hidden-480">上班打卡时间</th>

												<th class="hidden-480">下班打卡时间</th>
							...
							<c:forEach items="${requestScope.list }" var="li">
											<tr class="odd gradeX">
												...
												<td>${li.empname }</td>
												<td class="hidden-480">${li.startworktime }</td>

												<td class="hidden-480">${li.endworktime }</td>

												<td class="hidden-480">${li.worktime }</td>
												<c:if test="${li.attendancestatus==1 }">
													<td class="hidden-480">迟到</td>
												</c:if>
												<c:if test="${li.attendancestatus==2 }">
													<td class="hidden-480">请假</td>
												</c:if>
												<c:if test="${li.attendancestatus==3 }">
													<td class="hidden-480">旷工</td>
												</c:if>
