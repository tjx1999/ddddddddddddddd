...
<jsp:include page="../top.jsp"></jsp:include>
								...
								<div class="portlet-body">
									...
									<div class="clearfix">
										...
										<div class="btn-group" >
											...
											<a href="meeting_add.jsp"><button id="sample_editable_1_new" class="btn green">

											申请会议 <i class="icon-plus"></i>
										...
										<div class="controls">
											...
											<input class="m-wrap m-ctrl-medium date-picker" readonly size="16" type="text" value="" />
												...
												<td width="20%" style="padding-left:20px">
													<select  id="mett" class="span6 m-wrap" data-placeholder="Choose a Category" tabindex="1" style="width:100%" >

													<option value="1">第1会议室</option>

													<option value="2">第2会议室</option>

													<option value="3">第3会议室</option>

													</select>
												</td>
												<td>
													<button type="button" class="btn blue"><i class="icon-ok" onclick="Meeting(1)"></i> 查询</button>
												</td>
											</tr>
										</table>
									</div>
									...
									<ul class="nav nav-tabs" style="margin:0px">
													...
													<li class="active"><a href="meeting.jsp" data-toggle="tab">会议信息</a></li>
	...
	<script>
		...
		function Meeting(a){
			...
			var url="/shiro_web/flow/selectMeeting1.action";
			
		var ss=	$("#mett").val();
		      
alert(ss);
		$.post(url,{"indexpage":a,"meetinghome":ss},function(apiBean){
	        ...
	        $da.each(function(index,dom){
	            ...
	            item +="<td class='hidden-480'><a >第"+dom.meettinghome+"会议室</a></td>";
