								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form action="editLeave.do" method="post" class="horizontal-form">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" name="applyemp" class="m-wrap span12" value="${data.applyemp }">
															</div>
														</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="title" name="applytitle" class="m-wrap span12" value="${data.applytitle }">
															</div>
														</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<textarea name="applydetails" class="m-wrap span12" value="${data.applydetails }" ></textarea>
															</div>
														</div>
														<div class="control-group" >
															...
															<div class="controls">
																<select name="flowid" id="xxx" value="${data.flowid }">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<select name="applytype" class="m-wrap span12" value="${data.applytype }">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<div class="input-append">
																	...
																	<input size="16" type="text" name="begintime" value="" class="m-wrap"  value="${data.begintime }">
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">结束时间</label>
																...
																<div class="input-append ">
																	...
																	<input size="16" type="text" name="endtime" value="" class="m-wrap" value="${data.endtime }">
