						...
						<div class="span12">
								...
								<div class="portlet-body">
									...
									<ul class="nav nav-tabs" style="margin:0px">
													...
													<li class="active"><a href="bustravel.jsp" data-toggle="tab">出差信息</a></li>
									...
									<table class="table table-striped table-bordered table-hover" id="sample_1" style="border-top:none 0px">
										...
										<thead>
											...
											<tr>
												...
												<th class="hidden-480">出差地点</th>

												<th class="hidden-480">审核人</th>
												
												<th class="hidden-480">出差表状态</th>
										...
										<tbody>
											...
											<tr class="odd gradeX">
												...
												<td>${requestScope.data.evenctionemp }</td>
												<td >${requestScope.data.begintime }</td>

												<td class="hidden-480">${requestScope.data.address }</td>

												<td class="hidden-480">${requestScope.data.auditor }</td>
												
												<c:if test="${requestScope.data.eventionstatus==1}">
												<td class="hidden-480">未审核</td>
												</c:if>
												<c:if test="${requestScope.data.eventionstatus==2}">
												<td class="hidden-480">已批准</td>
												</c:if>
												<c:if test="${requestScope.data.eventionstatus==3}">
												<td class="hidden-480">已驳回</td>
												</c:if>
												<td class="hidden-480">${requestScope.data.endtime}</td>
