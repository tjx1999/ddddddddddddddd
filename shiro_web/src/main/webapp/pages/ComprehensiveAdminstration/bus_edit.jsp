					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">修改出差信息</a></li>
							</ul>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form action="editEvection.do" class="horizontal-form"  method="post">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="evenctionemp" name="evenctionemp" class="m-wrap span12" value="${data.evenctionemp }">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="auditor" name="auditor" class="m-wrap span12" value="${data.auditor }">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<div >
																	...
																	<input size="16" type="text" name="begintime" id="begintime" value="${data.begintime }"class="m-wrap">
													...
													<div class="span6 ">
														...
														<div class="controls">
																...
																<div > 
																	...
																	<input size="16" type="text" id="endtime" name="endtime" value="${data.endtime }"class="m-wrap">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label" >处理事件</label>
																...
																<div class="controls">
																<textarea name="title" id="title" rows="" cols="" >${data.title}</textarea>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="address" name="address" class="m-wrap span12" value="${data.address }">
													...
													<table style="width:100%;">
														<tr>
															<td align="center" style="padding-right:120px">
																<button type="submit" class="btn blue" value=" 确认修改"><i class="icon-ok"></i> 确认修改</button>

																<a href="bustravel.jsp"><button type="reset"class="btn" value="重置">重置</button></a>
