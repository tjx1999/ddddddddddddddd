								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form action="/shiro_web/flow/addMetting.action" method="post" onsubmit="return checktime2()" class="horizontal-form">
												...
												<div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">申请人姓名<font color="red" id="checkname"></font></label>

															<div class="controls">
																	
																<input type="text" id="applyemp" name="applyemp" onblur="checkname()" class="m-wrap span12" placeholder="请输入申请人姓名">
												...
												<!--/span-->
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">审批人姓名<font color="red" id="checkname2"></font></label>

															<div class="controls">
																		
																<input type="text" id="applyemp2" onblur="checkname2()" class="m-wrap span12" name="auditor" placeholder="请输入审批人姓名">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<select name="meettinghome"  class="m-wrap span12">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<div>
																	...
																	<input type="text"class="form-control input-sm"  id="begintimeString" name="begintime" />
													...
													<table style="width:100%;">
														<tr>
															<td align="center" style="padding-right:120px">
																...
																<a href="qicaoshenqing.jsp"><button type="button"class="btn" >返回</button></a>																
