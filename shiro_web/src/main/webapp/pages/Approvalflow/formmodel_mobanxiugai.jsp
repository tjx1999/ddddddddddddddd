					...
					<div class="span6" style="width: 100%">
						...
						<div class="portlet">
							...
							<div class="portlet-body">
								<form action="editname.do" method="post">
									<table
										...
										<tr align="center">
											...
											<td class="highlight">
												...
												<div class="success"></div> <input type="text" name="fname"
												value="${f.fname}" />
													<input type="hidden" name="fid" value="${f.fid }" />
											</td>
 
											<td><input type="submit" class="btn mini black" value="修改"> </td>
										</tr>
