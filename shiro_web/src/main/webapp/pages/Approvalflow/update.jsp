						...
						<form id="fileupload" action="//jquery-file-upload.appspot.com/" method="POST" enctype="multipart/form-data">
							...
							<div class="row-fluid fileupload-buttonbar">
								...
								<table>
										<tr>
											<td>
												<a>模板名称</a>&nbsp&nbsp&nbsp&nbsp<input type = ""/>
												<br>
												
												<div class="controls">
												<a>所以流程</a>&nbsp&nbsp&nbsp
							...
							<table>
								<tr>
									<td>
										...
										<a>请选择文件(doc格式)</a><span>Add files...</span>
										...
										<a href="mobanguanli.jsp" class="btn mini black"><i class="icon-trash"></i> 保存</a><a href="mobanguanli.jsp" class="btn mini black"><i class="icon-trash"></i> 返回</a>
								</div>
