...
<script type="text/javascript" src="flow/check.js"></script>

 </head>
 <body class="page-header-fixed" onload="find()">
				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<ul class="breadcrumb">
							...
							<li><a href="leavve_add.jsp">申请请假</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form action="/shiro_web/flow/addLeavess.action" method="post" class="horizontal-form" onsubmit="return check()">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="applyemp" name="applyemp" onblur="checkname()" class="m-wrap span12" placeholder="请输入姓名">
																<font color="red" id="checkname"></font>
															</div>
														</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="applytitle" onblur="checktitle()" name="applytitle" class="m-wrap span12" placeholder="请输入排班人员姓名">
																<font id="checktitle" color="red"></font>
															</div>
														</div>
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<textarea name="applydetails"  class="m-wrap span12" ></textarea>
															</div>
														</div>
														<div class="control-group">
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">开始时间</label>
																...
																<div class="input-append">
																	...
																	<input  class="form-control input-sm" onclick="checkflow()" readonly size="16" id="begintimeString" name="begintime" type="text"  />
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">结束时间</label>
																...
																<div class="input-append">
																	...
																	<input class="form-control input-sm" readonly size="16" name="endtime" type="text" id="endtimeString"  />
																	<span class="add-on"><i class="icon-calendar"></i></span>
...
<div>
  <script type="text/javascript" src="../media/js/bootstrap-datepicker.js"></script>
	...
	<script type="text/javascript" src="flow/selectflow.js"></script>
	...
	<script>
		...
		function find(){
			...
			$.post("/shiro_web/flow/findFlowmodle.action",{},function(date){
		    	 
			
				var $da=$(date);
		        var sum=$("#flowid");
		        $da.each(function(index,dom){
	            sum.append("<option value='"+dom.remark1+"'>"+dom.remark1+"</option>");
		...
		$('#begintimeString').datetimepicker({
	        ...
	        var starttime=$("#begintimeString").val();
	        $("#endtimeString").datetimepicker('setStartDate',starttime);
	        $("#begintimeString").datetimepicker('hide');
	    });
		...
		$('#endtimeString').datetimepicker({
	        ...
	        var starttime=$("#begintimeString").val();
	        var endtime=$("#endtimeString").val();
	        $("#begintimeString").datetimepicker('setEndDate',endtime);
	        $("#endtimeString").datetimepicker('hide'); 
