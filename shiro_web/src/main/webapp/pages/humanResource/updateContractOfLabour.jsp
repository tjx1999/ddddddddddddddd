					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">修改员工劳动合同</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-title">
											...
											<div class="caption"><i class="icon-reorder"></i>修改合同信息</div>
										...
										<div class="portlet-body form">
											...
											<form action="#" class="horizontal-form">
												...
												<h3 class="form-section">修改合同信息</h3>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="Chee Kin" readonly="readonly">
