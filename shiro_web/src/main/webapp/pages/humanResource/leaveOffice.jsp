						...
						<div class="portlet-body">
							...
							<div class="clearfix">
								...
								<div class="btn-group">
									...
									<a href="../humanResource/addLeaveOffice.jsp"><button
							...
							<table class="table table-striped table-bordered table-hover"
								...
								<tbody>
									...
									<tr class="odd gradeX">
										...
										<td><span class="label label-success">系统管理员</span>
										</td>
										...
										<td>
											...
											<a href="../humanResource/updateLeaveOffice.jsp" class="btn blue icn-only">
