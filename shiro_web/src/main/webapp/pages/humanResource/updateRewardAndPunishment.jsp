					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">修改奖惩信息</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-title">
											...
											<div class="caption"><i class="icon-reorder"></i>修改奖惩信息</div>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="appId" name="appId" class="m-wrap span12" placeholder="" readonly="readonly" value="001">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="appType" name="appType" class="m-wrap span12" placeholder="" value="小李">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="appPeople" name="appPeople" class="m-wrap span12" placeholder="" value="张三" readonly="readonly">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="dealName" name="dealName" value="经理"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="sumitPeople" name="sumitPeople" class="m-wrap span12" value="张三"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="appTime" name="appTime" class="m-wrap span12" value="2016-8-25"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="status" name="status" class="m-wrap span12" placeholder="" value="未奖惩">
