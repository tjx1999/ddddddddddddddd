					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">新增人事档案信息</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-title">
											...
											<div class="caption"><i class="icon-reorder"></i>人事档案</div>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="请输入姓名">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="请输入政治面貌">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="请输入年龄">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" placeholder="请输入工作职位"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" placeholder="请输入最高学历"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="请输入生日">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" placeholder="请输入电话"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="请输入家庭地址">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" placeholder="请输入邮箱"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" placeholder="请输入个人简介"> 
												...
												<!--/span-->
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" value="1234" placeholder="请输入密码"> 
													...
													<div class="control-group">
														...
														<div class="input-append date form_datetime">
															...
															<input size="16" type="text" value="" class="m-wrap" placeholder="请输入入职日期"> 
															<span class="add-on">
															<i
																class="icon-calendar">
															</i>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="firstName" class="m-wrap span12" placeholder="请输入身份证号">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" placeholder="请输入你的登录名"> 
												...
												<!--/span-->
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label">在岗状态</label>

															<div class="controls">

																<!-- <input type="text" class="m-wrap span12" value="1234" placeholder="请输入密码">  -->
																<select
																	class="m-wrap span12" data-placeholder="Choose a Category"
																	>
