				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							职位变更 <small>Become a regular worker</small>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group" >
										...
										<a href="../humanResource/addBecomeAregularWorker.jsp"><button id="sample_editable_1_new" class="btn green">增加
										 <i class="icon-plus"></i></button></a>
										...
										<tr>
											<td width="20%" style="padding-left:20px">
												<div class="controls">
														...
														<label class="control-label" for="firstName">申请类型</label>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1" style="border-top:solid 1px #DDDDDD">
									...
									<tr class="odd gradeX">
											...
											<td width="30%">
												<select class="btn white icn-only"
												data-placeholder="Choose a Category" tabindex="1"
													style="width:140px;height:35px">
												<option value="">职位</option>
			
												<option value="Category 1">请选择</option>
			
												<option value="Category 2">经理</option>
			
												<option value="Category 2">研发部门</option>
			
											</select>
											<a href="../humanResource/updatePersonalRecords.jsp" class="btn blue icn-only">
												<i class="halflings-icon user white" style=" font-style:normal">变更</i>
											</a>
											</td>
