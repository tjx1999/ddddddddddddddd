				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							新增奖惩申请 <small>Add employee contract </small>
					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">新增奖惩申请</a>
								</li>
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form action="#" class="horizontal-form">
												...
												<h4 class="form-section">新增奖惩信息</h4>
										...
										<div class="portlet-body form">
											...
											<form action="#" class="horizontal-form">
												...
												<h4 class="form-section">申请奖惩信息</h4>
