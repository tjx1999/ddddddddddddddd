				...
				<div class="row-fluid">
					...
					<div class="span12">
						...
						<h3 class="page-title">
							...
							劳动合同 <small>contract of labour</small>
							...
							<div class="portlet-body">
								...
								<div class="clearfix">
									...
									<div class="btn-group" >
										...
										<a href="../humanResource/addContractOfLabour.jsp"><button id="sample_editable_1_new" class="btn green">增加 <i class="icon-plus"></i></button></a>
									...
									<table width="100%">
										<tr>
											<td width="20%" style="padding-left:20px">
												<div class="controls">
														<label class="control-label" for="firstName">合同编号</label>
											...
											<td width="20%" style="padding-left:20px">
												...
												<label class="control-label" for="firstName">合同类型</label>
												<select class="m-wrap medium" data-placeholder="Choose a Category" tabindex="1" style="width:80%">
		
														<option value="">请选择</option>
		
														<option value="Category 1">劳动合同</option>
		
														<option value="Category 2">劳务合同</option>
														
														<option value="Category 2">培训合同</option>
														
														<option value="Category 2">保密与竞业禁止协议</option>
											...
											<td width="20%" style="padding-left:20px">
												<div class="controls">
														<label class="control-label" for="firstName">档案编号</label>
														<input type="text" placeholder=""
														class="m-wrap medium"/>
												</div>
											</td>
										...
										<tr>
											<td width="20%" style="padding-left:20px">
												...
												<label class="control-label" for="firstName">部&nbsp;门</label>
												<select class="m-wrap medium" data-placeholder="Choose a Category" tabindex="1" style="width:80%">
		
														<option value="">请选择</option>
		
														<option value="Category 1">总经办</option>
											...
											<td width="20%" style="padding-left:20px">
												<div class="span6 ">
													...
													<div class="control-group">
														...
														<label class="control-label" for="firstName">签订日期</label>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1" style="border-top:solid 1px #DDDDDD">
									...
									<thead>
										...
										<tr>
											...
											<th class="hidden-480">档案编号</th>

											<th class="hidden-480">员工姓名</th>

											<th class="hidden-480">合同类型</th>
											
											<th class="hidden-480">状态</th>
											
											<th class="hidden-480">签订日期</th>
											
											<th class="hidden-480">开始日期</th>
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-480"><a href="mailto:shuxer@gmail.com">001</a></td>

											<td class="hidden-480">张飞</td>

											<td class="center hidden-480">转正</td>

											<td ><span class="label label-success">已审核</span></td>
											
											<td class="hidden-480">2007-10-20</td>

											<td class="hidden-480">2007-10-26</td>
											
											<td class="hidden-480">2007-12-26</td>
											...
											<a href="../humanResource/updateContractOfLabour.jsp" class="btn blue icn-only">
