					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">修改任务</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<form action="editTask.do" class="horizontal-form" method="post">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="title"  name="title" value="${data.title }" class="m-wrap span12" placeholder="Chee Kin">
													...
													<!--/span-->
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="primarycharge" name="primarycharge" value="${data.primarycharge }" class="m-wrap span12" placeholder="Chee Kin">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<select  name="taskstatus" class="m-wrap span12">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="minorcharge" name="minorcharge"  value="${data.minorcharge }" class="m-wrap span12"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="taskid" name="taskid"  value="${data.taskid }" class="m-wrap span12"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="initiator" name="initiator" value="${data.initiator }" class="m-wrap span12" placeholder="Chee Kin">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<table width="100%">
																...
																<input  value="${data.begintime }"  size="16" id="begintime" name="begintime"  type="text"  />
															...
															<label class="control-label" >结束时间</label>
																...
																<input  value="${data.endtime }" size="16" id="endtime" name="endtime"  type="text"  />
