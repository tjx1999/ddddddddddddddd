					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">编辑计划</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-body form">
											...
											<!-- BEGIN FORM-->
											<form action="editPlane.do" class="horizontal-form" method="post">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="planeid" value="${data.planeid }" class="m-wrap span12"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="submitor" value="${data.submitor}" class="m-wrap span12"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<select name="planeStatus" class="m-wrap span12">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" name="title" value="${data.title}" class="m-wrap span12"> 
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<table width="100%">
																...
																<input class="m-wrap m-ctrl-medium date-picker" name="begintime" value="${data.begintime}"   size="16" type="text" value="" />
															...
															<div class="controls">
																...
																<input class="m-wrap m-ctrl-medium date-picker" name="endtime"  value="${data.endtime}"   size="16" type="text" value="" />
