...
<link href="../media/css/bootstrap.min.css" rel="stylesheet" type="text/css"/>
	...
	function checkTask(){
		...
		var titleok = checkTaskTitle();
		
		
		var primarychargeok = checkTaskPrimarycharge();
		/* alert(primarychargeok); */
		var minorchargeok = checkTaskMinorcharge();
		alert("minorchargeok"+minorchargeok);
		var initiatorok = checkTaskInitiator();
;
		var begintimeok = checkTaskBegintime();
		var endtimeok = checkTaskEndtime();
		
		
		
		if(titleok && primarychargeok && minorchargeok && initiatorok && begintimeok && endtimeok){
			return true;
		...
		var title = $("#title").val();
		 var reg =/^[" "]+$/; 
			var titleMsg = $("#titleMsg");
			 ...
			 if(title == null || reg.test(title) || "" == title){ 
		
				 titleMsg.html("任务标题不能为空。。。");
				return false;
			}else{
				titleMsg.html("");
				return true;
	...
	function checkTaskPrimarycharge(){
		var primarycharge = $("#primarycharge").val();
		
		var primarychargeMsg =$("#primarychargeMsg");	
		var result = false;
		$.ajax({
				
			async:false,
			url:"queryByPrimarycharge.do",
			data:{"primarycharge":primarycharge},
			success:function(data){
				
				if(data==1){
					primarychargeMsg.html("");
					result = true;
				}else{
					primarychargeMsg.html("对不起，此员工不存在！！！");
	...
	function checkTaskMinorcharge(){
		
		var minorcharge = $("#minorcharge").val();
		
		var minorchargeMsg =$("#minorchargeMsg");	
		var result = false;
		$.ajax({
			async:false,
			url:"queryByMinorcharge.do",
			data:{"minorcharge":minorcharge},
			success:function(data){
				...
				if(data==1){
					...
					minorchargeMsg.html("对不起，此员工不存在！！！");
	...
	function checkTaskInitiator(){
		var initiator = $("#initiator").val();
	
		var initiatorMsg =$("#initiatorMsg");	
		var result = false;
		$.ajax({
			async:false,	
			url:"queryByInitiator.do",
					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">新增任务</a></li>
								...
								<div class="tab-pane active" id="tab_1">
									...
									<div class="portlet box blue">
										...
										<div class="portlet-title">
											...
											<div class="caption"><i class="icon-reorder"></i>任务</div>
										...
										<div class="portlet-body form">
											...
											<form action="addTask.do" class="horizontal-form" method="post" onsubmit="return checkTask()">
												...
												<div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" id="title"  name="title" class="m-wrap span12" placeholder="Chee Kin" onblur="checkTaskTitle()">
													...
													<!--/span-->
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">主办人员</label>

															<div class="controls">

																<input type="text" id="primarycharge" name="primarycharge" class="m-wrap span12" placeholder="Chee Kin" onblur="checkTaskPrimarycharge()">
																<span id="primarychargeMsg" ></span>
												...
												<div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label">协办人员</label>

															<div class="controls">

																<input type="text" id="minorcharge" name="minorcharge" class="m-wrap span12" onblur="checkTaskMinorcharge()"> 
																	<span id="minorchargeMsg" ></span>
															</div>
												...
												<div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<label class="control-label" for="firstName">发起者</label>

															<div class="controls">

																<input type="text" id="initiator" name="initiator" class="m-wrap span12" placeholder="Chee Kin" onblur="checkTaskInitiator()">
																<span id="initiatorMsg" ></span>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<table width="100%">
																...
																<input  size="16" id="begintime" name="begintime"  type="text" onblur="checkTaskBegintime()" />
															...
															<label class="control-label" >结束时间</label>
																...
																<input size="16" id="endtime" name="endtime"  type="text" onblur="checkTaskEndtime()" />
											...
											<div class="span6 ">
														...
														<div class="control-group" >
															...
															<div class="controls">
																...
																<Textarea  name="taskdetails" id="taskdetails" class="m-wrap span12"  
																rows="5"
																>
																</Textarea>
															</div>
