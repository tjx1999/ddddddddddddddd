					...
					<div class="span12">
							...
							<div class="portlet-body">
								...
								<ul class="nav nav-tabs" style="margin:0px">
												...
												<li class="active"><a href="#tab_1_11" data-toggle="tab">权限信息列表</a></li>
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1" style="border-top:none 0px">
									...
									<c:forEach items="${datas}" var="s">
										<tr >
											...
											<td class="hidden-480">${s.parentid}</td>

											<td>
											<a href="queryRightById.do?rightid=${s.rightid}"  class="btn green mini">编辑</a>&nbsp;&nbsp;
											<a href="deleteRight.do?rightid=${s.rightid}"  class="btn red mini">删除</a>			
											</td>
