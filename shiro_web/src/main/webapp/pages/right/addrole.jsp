					...
					<div class="span12">
						...
						<div class="tabbable tabbable-custom boxless">
							...
							<ul class="nav nav-tabs">
								...
								<li class="active"><a href="#tab_1" data-toggle="tab">新增角色</a></li>
												 ...
												 <div class="row-fluid">
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<input type="text" class="m-wrap span12" id="roleid" name="roleid"> 
															</div>
													...
													<div class="span6 ">
														...
														<div class="control-group">
															...
															<div class="controls">
																...
																<input type="text" class="m-wrap span12" id="rolename" name="rolename"> 
