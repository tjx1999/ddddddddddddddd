								...
								<div class="clearfix">
										...
										<div class="row-fluid">
													...
													<div class="hidden-480" >
														<label class="control-label" >添加角色权限</label>
													</div>
														...
														<div class="hidden-480" >
															<input class="control-label" name="roleid" id="roleid" readonly="readonly" value="${roleid }"/>
														</div>
														<div class="control-group">
															...
															<div class="controls">
																...
																<select  name="rightid" id ="rightid" >
																	<c:forEach items="${requestScope.rlist }" var="li"  >
	    				 											<option value="${li.rightid}">${li.rightname }</option>
	  										 						</c:forEach>
																	</select>
													
																	<th colspan="2" class="hidden-480">
								...
								<table class="table table-striped table-bordered table-hover" id="sample_1" style="border-top:none 0px">
									...
									<tbody>
										...
										<tr class="odd gradeX">
											...
											<td class="hidden-480">${s.rightid }</td>

											<td class="hidden-480">${s.rightname }</td>


											<td><a href="deleteRoleRight.do?rightid=${s.rightid }&roleid=${roleid}"  class="btn red mini">删除此权限</a></td>
